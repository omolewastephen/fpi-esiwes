<?php
         ...
         && ($_FILES["siwesCompLetter"]["size"] < 3000000)) || ($_FILES['siwesCompLetter']['name'] == ''))
        {
                ...
                if(mysqli_num_rows($thepost) > 1)
                {
                    // Update the siwes posting
                    $newprogress = mysqli_query($connection,"UPDATE siwespost SET siwesCompName = '$siwesCompName', siwesCompAdd = '$siwesCompAdd', siwesCompCountry = '$siwesCompCountry', siwesCompState = '$siwesCompState', siwesCompLetter = '$siwesCompLetter', siwesSupervisor = '$siwesSupervisor', siwesSupervisorNo = '$siwesSupervisorNo', siwesSupervisorSkype = '$siwesSupervisorSkype', siwesStudentSkype = '$siwesStudentSkype' WHERE siwesMat = '$siwesMat'");
                }else{
                    // Insert the new siwes posting
                    $newprogress = mysqli_query($connection,"INSERT INTO siwespost (siwesMat, siwesCompName, siwesCompAdd, siwesCompCountry, siwesCompState, siwesCompLetter, siwesCompDate, siwesCompTime, siwesSupervisor, siwesSupervisorNo, siwesSupervisorSkype, siwesStudentSkype) 
                            VALUES ('$siwesMat', '$siwesCompName','$siwesCompAdd','$siwesCompCountry', '$siwesCompState','$siwesCompLetter','$siwesCompDate', '$siwesCompTime', '$siwesSupervisor','$siwesSupervisorNo','$siwesSupervisorSkype', '$siwesStudentSkype')");
                }
