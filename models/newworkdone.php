<?php
        ...
        if($_POST['logbookDesc'] == '')
        {
                        ...
                        || ($_FILES['logbookAttach']['name'] == ''))
                {
                        ...
                        $newprogress = mysqli_query($connection,"INSERT INTO logbook (logbookMat, logbookDesc, logbookAttach, logbookDate, logbookTime) 
                        ...
                        if($newprogress)
                        {
                                ...
                                //$pdflogging = 'http://covenantuniversity.edu.ng/~/attachlogs/'.$logbookMat.' '.$logbookDate.' ('.$logbookId.').pdf';
