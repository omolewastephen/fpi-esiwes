<?php 
    ...
    $siwespost = mysqli_query($connection,$getsiwes);
			...
			<div class="row">
				<div class="col-sm-8 page-content">
					<div class="white-container mb0">
						...
						<?php while($siwesrow = mysqli_fetch_array($siwespost)){ ?>
						...
						<?php } ?>
						<?php if(mysqli_num_rows($thepost) < 1) {?>
						...
						<?php }else{?>
							<table class="table-hover">
								...
								<tbody>	
								<?php while($stdntrow = mysqli_fetch_array($thepost)){ ?>							
									<tr>
